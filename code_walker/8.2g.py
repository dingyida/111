...
def main():
    ...
    for idx, (fp, t) in enumerate(zip(files, frames)):
        ...
        print(f"[Frame {t}] Empirical AoI: inc={emp_aoi['incremental'][idx]:.4f}, prop={emp_aoi['proportional'][idx]:.4f}, full={emp_aoi['full'][idx]:.4f}; Theo-inc={theo_inc_aoi[idx]:.4f}; Theo-SLSQP={theo_inc_aoi2[idx]:.4f}")
    ...
    print(
        f"Average Empirical AoI → inc={avg_inc:.4f}, prop={avg_prop:.4f}, full={avg_full:.4f}; Theo-inc={avg_theo_inc:.4f}"
    )
