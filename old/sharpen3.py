...
# ─── Configuration ──────────────────────────────────────────────────────────
POOL_KERNEL_SIZE     = 10    # size of the max‐pooling window (3×3 by default)
POOL_KERNEL_SIZE2     = 3
...
kernel2 = np.ones((POOL_KERNEL_SIZE2, POOL_KERNEL_SIZE2), dtype=np.uint8)
...
depth_map2 = cv2.dilate(edges_d, kernel2)
...
cv2.imshow('Depth map 2', depth_map2)
